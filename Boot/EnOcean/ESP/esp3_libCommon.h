...
typedef enum
{
    ...
    RM_RPC_RESET_DEFAULT                          = MENRED_RPC_CMD_BASE + 0x37,     
    RM_RPC_UPGRADE_LONG_DATAS                     = MENRED_RPC_CMD_BASE + 0x38,
    ...
    RM_RPC_RESET_DEFAULT_ANS                      = RM_ANSWER_START + RM_RPC_RESET_DEFAULT,
    RM_RPC_UPGRADE_LONG_DATAS_ANS                 = RM_ANSWER_START + RM_RPC_UPGRADE_LONG_DATAS,
}  RM_RPC;
