...
#include <intrinsics.h>
    ...
    #define ESP3_RX_BUF_MAX                                        (64)
    #define ESP3_TX_BUF_MAX                                        (160)
    #define ESP3_TX_QUEU_BUF_MAX                                   (64)
    #define RADIO_BUFF_LENGTH                                      (64)
    #define ESP3_RX_QUEUE                                          (10)
    #define ESP3_TX_QUEUE                                          (10)
    #define LRN_TAB_CHANNEL_MAX                                    (24)
